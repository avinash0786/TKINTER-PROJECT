...
def details_see():
    ...
    head = Label(top, text = "PRICE", fg = "GREEN", bg = "white",font = "Verdana 10 bold").place(x = 120,y = 270)
    ...
    #**********************QUERY******************************
    query="select * from phones where id={}".format(index)
